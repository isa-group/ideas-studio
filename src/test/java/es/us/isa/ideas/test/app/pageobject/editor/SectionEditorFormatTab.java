...
public class SectionEditorFormatTab extends EditorPage {
    ...
    private static class SectionEditorFormatTabTestCase extends TestCase {
        ...
        public void testIsEditorFormatActivated(String formatName) {
            ...
            // Get activated form tab.
            PageObject.getWebDriverWait().until(ExpectedConditions.visibilityOf(formatTab.formatTabActive));
        ...
        public void testActivateFormatTab(String formatName) {
            ...
            // Obtain format element to click
            PageObject.getWebDriverWait().until(ExpectedConditions.visibilityOf(formatTab.editorFormatsContainer));
            WebElement formatElement = formatTab.editorFormatsContainer.findElement(By.linkText(formatName));
            
            formatTab.clickOnClickableElement(formatElement);
            
            SectionEditorFormatTab.testIsEditorFormatActivated(formatName);
