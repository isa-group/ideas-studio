...
public class TC01_RegisterMaxLengthFormField extends
	...
	public void step02_insertBigStringToFormFields() {
		...
		testResult = !getInputValueSelector("#name").equals("")
				&& !getInputValueSelector("#email").equals("")
				&& !getInputValueSelector("#phone").equals("")
				&& !getInputValueSelector("#address").equals("");
	...
	@Test
	public void step04_returnRegisterButton() {

		String selectorBtnModal = "#loginFailPanel > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)";
		waitForVisibleSelector(selectorBtnModal);

		testResult = !getTextSelector(selectorBtnModal).toLowerCase().equals(
				"return to login");
		assertTrue(testResult);
