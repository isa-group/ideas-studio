...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>        
        ...
        <script type="text/javascript" src='js/dyntree/jquery.dynatree.js'></script> 
        <script type="text/javascript" src="js/vendor/jquery.ui.widget.js"></script>        
        <script type="text/javascript" src="js/vendor/jquery.iframe-transport.js"></script>
        <!-- Iframe Transport is required for file AJAX upload in browsers without support for XHR file uploads -->
        <script type="text/javascript" src="js/vendor/jquery.fileupload.js"></script>

        <script type="text/javascript" src="js/vendor/jquery.contextMenu-custom.js"></script>
        ...
        <script type="text/javascript" src='js/contextAction.js' ></script> 

        <script type="text/javascript" src="js/fileApi.js"></script>
        <script type="text/javascript" charset="utf-8" src="js/commandApi.js" ></script>
        <script type="text/javascript" charset="utf-8" src="js/operationalReplication.js" ></script>
        <script type="text/javascript" src="js/plugins.js"></script>
        <script type="text/javascript" src="js/main.js"></script>
        <script type="text/javascript" src='js/workspaceManager.js'></script>
        <script type="text/javascript" src='js/vendor/isotope.pkgd.js'></script>
