...
<ideas:app-modal-dialog>
    <div class="modal-header">
        ...
        <h4 class="modal-title"><spring:message code="editor.actions.modal.print_info.title"/></h4>
    </div>
    <div class="modal-body">
        <div class="input-group" id="modalCreationField" >
            <span class="input-group-addon">
                <spring:message code="editor.actions.modal.print_info.msg" arguments="${workbenchName}" />
            </span>
        </div>
    </div>
