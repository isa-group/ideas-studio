	...
	<div id="intro">
		<div class="container">
			<div class="row centered">
				...
				<br>
                                <h2 class="text-info">“The use of precise, repeatable experiments is the hallmark of a mature scientific or engineering discipline”</h2>                                
                                <span class="cite">
                                ...
                                <span class="cite">
                                    ...
                                    Information and Software Technology. Volume 56, Issue 8, August 2014, Pages 1033–1048
                                </span>
				<br>                                
                                ...
                                <span class="cite">
                                    Eiben, A., Jelasity, M.: A critical note on experimental research methodology in EC. Computational Intelligence, Proceedings of the World on Congress on 1 (2002) 582–587</span>
                                <h2 class="text-danger right">"Most Software Engieering experiments results have not been reproduced"</h2>
                                <span class="cite">Natalia Juristo, Omar S. Gómez: Replication of Software Engineering Experiments, chapter of Empirical Software Engineering and Verification. Lecture Notes in Computer Science Volume 7007, 2012, pp 60-88</cite>
